         // the constants were copied from messages.inc and other public available sources
Unit
          iu_WinMessages;
...
Function
          getWinMsgName( aWinMsgVal: tWinMessages): String;
...
Begin
          ...
          {$IOChecks OFF}
          writeStr( Result, aWinMsgVal);
          If IOResult= 107
             Then
             Begin
                  vIn1:= intEger( aWinMsgVal);
                  Result:= vIn1.toString();
          End;
