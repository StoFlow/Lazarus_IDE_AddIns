...
## Lazarus Search Window Pal (LazSRVWndPal)

Purpose

- Is just and only to make the contents of the search results window better readable (font size) (and maybe some fun)

Hints

- ~~First shot - font height is only configurable by changing code (see folder "doc")~~
